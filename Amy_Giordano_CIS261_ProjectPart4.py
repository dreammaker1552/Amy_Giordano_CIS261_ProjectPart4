...
def GetUserName():
    while True:
        username = input("Please enter your username, or type 'End' to exit: ")
...
def GetUserRole():
     while True:
        userrole = input("Please enter your user role (Admin or User): ")
        if userrole.lower() == "admin" or userrole.lower() == "user":
            return userrole.lower()
        else:
            print("Invalid user role. Please enter either 'Admin' or 'User'.")
def printuserinfo():
...
if UserRole == "NONE":
    ...
    if UserRole == "ADMIN":
        EmpFile = open("employee_records.txt", "a+")
        while True:
            empname = GetEmpName()
        ...
        print("You do not have permission to enter data.")
